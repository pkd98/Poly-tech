...
public class BookUtil {
    ...
    // private int possibleBookCount; // 대여 가능 도서 개수 저장용
...
//        }
        ...
        for (Book book : bookList) {
            if (book.getBookId() == ID) {
                bookStack.add(bookList.get(ID)); // 삭제 undo 기능을 위해 스택에 저장
                bookList.remove(ID);
    ...
    public static void bookSort() { // 최근 출간 순서대로 책 정렬
